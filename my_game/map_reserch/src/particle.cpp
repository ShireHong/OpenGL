...
void ParticleGenerator::Update(GLfloat dt, PlaneObject &obj, GLuint newParticles, glm::vec2 offset)
{
...
void ParticleGenerator::respawnParticle(Particle &particle, PlaneObject &obj, glm::vec2 offset )
{
