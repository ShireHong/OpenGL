...
public:
	...
	void set_vec4(const char* name, float x, float y, float z, float w, bool useshader = false);
	void set_vec4(const char* name, const glm::vec4 &value, bool useshader = false);
